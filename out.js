...
var require_util = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/util.js"(exports2) {
    "use strict";
...
var require_sqlite_error = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/sqlite-error.js"(exports2, module2) {
    "use strict";
...
var require_bindings = __commonJS({
  "node_modules/.pnpm/bindings@1.5.0/node_modules/bindings/bindings.js"(exports2, module2) {
    ...
    function bindings(opts) {
      ...
      var tries = [], i = 0, l2 = opts.try.length, n2, b, err;
      for (; i < l2; i++) {
        n2 = join.apply(
          null,
        ...
        tries.push(n2);
        try {
          b = opts.path ? requireFunc.resolve(n2) : requireFunc(n2);
          if (!opts.path) {
            b.path = n2;
          }
          return b;
...
var require_wrappers = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/wrappers.js"(exports2) {
    "use strict";
...
var require_transaction = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/transaction.js"(exports2, module2) {
    "use strict";
    var { cppdb } = require_util();
...
var require_pragma = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/pragma.js"(exports2, module2) {
    "use strict";
...
var require_backup = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/backup.js"(exports2, module2) {
    "use strict";
    var fs3 = require("fs");
    var path = require("path");
...
var require_serialize = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/serialize.js"(exports2, module2) {
    "use strict";
    var { cppdb } = require_util();
...
var require_function = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/function.js"(exports2, module2) {
    "use strict";
    var { getBooleanOption, cppdb } = require_util();
    module2.exports = function defineFunction(name2, options, fn) {
      if (options == null) options = {};
...
var require_aggregate = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/aggregate.js"(exports2, module2) {
    "use strict";
    var { getBooleanOption, cppdb } = require_util();
    module2.exports = function defineAggregate(name2, options) {
      if (typeof name2 !== "string") throw new TypeError("Expected first argument to be a string");
...
var require_table = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/table.js"(exports2, module2) {
    "use strict";
    var { cppdb } = require_util();
    module2.exports = function defineTable(name2, factory) {
      if (typeof name2 !== "string") throw new TypeError("Expected first argument to be a string");
...
var require_inspect = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/methods/inspect.js"(exports2, module2) {
    "use strict";
...
var require_database = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/database.js"(exports2, module2) {
    "use strict";
    var fs3 = require("fs");
    var path = require("path");
    ...
    function Database(filenameGiven, options) {
      ...
      if (!anonymous && !fs3.existsSync(path.dirname(filename))) {
...
var require_lib = __commonJS({
  "node_modules/.pnpm/better-sqlite3@12.2.0/node_modules/better-sqlite3/lib/index.js"(exports2, module2) {
    "use strict";
...
// tools/mac-database.js
var require_mac_database = __commonJS({
  "tools/mac-database.js"(exports2, module2) {
    "use strict";
    var Database = require_lib();
    var path = require("path");
    var dbPath = path.join(__dirname, "mac-addresses.db");
  ...
  `;
    ...
    function getUnusedMacAddresses() {
      ...
      return db.prepare(selectSQL).all(0);
    }
    function markMacAsUsed2(macAddress) {
      const updateSQL = `
...
// src/main.ts
var import_mac_database = __toESM(require_mac_database());

// src/global/fn/fetchHotspotLogin.ts
...
// src/global/fn/fetchHotspotLogin.ts
var routerIp = process3.env.ROUTER_IP;
async function fetchHotspotLogin(macAddr) {
  ...
  try {
    newPageResp = await fetchWithTimeout(finalUrl).then((r2) => r2.text());
  } catch (e2) {
    console.error(e2);
  }
  if (newPageResp !== null) {
...
function compile$1(options = {}) {
  ...
  return function(html, metadata = void 0) {
    return process4(html, metadata, options, picker, findBaseElements, limitedWalk);
  };
}
function process4(html, metadata, options, picker, findBaseElements, walk) {
...
// src/main.ts
var networkInterfaceName = process5.env.NETWORK_IFACE_NAME;
if (process5.platform === "win32") {
  networkInterfaceName = process5.env.NETWORK_IFACE_NAME_WIN;
}
var main = async () => {
      ...
      try {
        ...
        if (pageResponse) {
          ...
          if (pageResponse.match(/Kode\ Voucher\ Benar/)) {
            ...
            (0, import_mac_database.markMacAsUsed)(macAddr);
